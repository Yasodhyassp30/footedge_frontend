    ...
    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
      <div style={{ height: 400, width: '45%' }}>
        ...
        <ResponsiveBar
          ...
          keys={['distance']}
          indexBy="player"
          margin={{ top: 50, right: 130, bottom: 70, left: 60 }} // Increased bottom margin to accommodate rotated labels
          padding={0.3}
          ...
          axisBottom={{
            tickSize: 5,
            tickPadding: 5,
            tickRotation: 90, // Rotate the labels
            legend: 'Player',
            legendPosition: 'middle',
            legendOffset: 40 // Adjust the offset to fit the rotated labels
          }}
          axisLeft={{
            tickSize: 5,
            tickPadding: 5,
